...
*I recently completed my B.Tech in Artificial Intelligence & Data Science (2022–2026) from Poornima College of Engineering, Jaipur.*
...
### 🎬 [Movie Recommendation System](https://github.com/bhrigu136/movie-recommender-system)
> Content-based recommender that suggests 5 similar movies using text metadata.

Combines genres, cast, director, and overview into a single feature column, vectorizes it with CountVectorizer, then ranks results by cosine similarity. Movie posters are fetched live from the TMDB API.
...
- **Payroll Engine** — live-computed payroll that recalculates on every read. Covers PF, ESI, PT, TDS, pro-rated salaries, overtime multipliers, and leave deductions.

---

<div align="center">

*If something here looks interesting, feel free to open an issue, fork a repo, or just say hi.*
